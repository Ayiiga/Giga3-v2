...
describe("service worker cache version", () => {
  it("uses marketplace simple cache name (v214)", () => {
    ...
    expect(sw).toContain('NEXT_STATIC_CACHE = "giga3-next-static-v214"');
    expect(sw).toContain('APP_SHELL_CACHE = "giga3-app-shell-v214"');
