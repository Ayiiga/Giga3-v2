...
describe("service worker cache version", () => {
  it("uses marketplace upload reports cache name (v215)", () => {
    ...
    expect(sw).toContain('NEXT_STATIC_CACHE = "giga3-next-static-v215"');
    expect(sw).toContain('APP_SHELL_CACHE = "giga3-app-shell-v215"');
