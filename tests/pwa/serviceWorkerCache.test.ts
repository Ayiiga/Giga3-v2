...
describe("service worker cache version", () => {
  it("uses gigaedit timecode fix cache name (v213)", () => {
    ...
    expect(sw).toContain('NEXT_STATIC_CACHE = "giga3-next-static-v213"');
    expect(sw).toContain('APP_SHELL_CACHE = "giga3-app-shell-v213"');
