...
export const GigaSocialCreatorStudio = memo(function GigaSocialCreatorStudio({
  ...
  return (
    <div className="gigasocial-creator-studio rounded-2xl border border-border bg-white p-4">
      ...
      <p className="mt-3 rounded-xl border border-border bg-white px-3 py-2 text-xs text-muted">
