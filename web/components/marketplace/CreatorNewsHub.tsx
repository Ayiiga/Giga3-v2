  ...
  return (
    <section className="rounded-2xl border bg-card p-6">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        <div>
          <div className="mb-2 inline-flex items-center gap-2 rounded-full bg-violet-500/10 px-3 py-1 text-sm font-medium text-violet-800">
            <Newspaper className="h-4 w-4" aria-hidden />
            Creator news desk
          </div>
          <h2 className="text-lg font-semibold">Latest news &amp; social headlines</h2>
          <p className="mt-2 text-sm text-muted">
            Read headlines from major news outlets and social discussion feeds. Verify claims
            before you reference them in your products.
          </p>
          {fetchedAt && (
        ...
        >
          <RefreshCw className={`mr-2 h-4 w-4 ${loadingNews ? "animate-spin" : ""}`} aria-hidden />
