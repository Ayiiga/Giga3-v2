...
export const ChatChrome = memo(function ChatChrome({
  ...
  const navLink =
    "hidden touch-target items-center rounded-xl px-3 py-2 text-sm font-medium text-muted hover:bg-zinc-100 hover:text-foreground sm:inline-flex sm:gap-1.5";

  return (
    <header className="chat-header-stable flex min-h-14 flex-wrap items-center gap-2 border-b border-border bg-white px-4 py-2 sm:gap-3 sm:px-5">
      <button
        type="button"
        className="touch-target inline-flex items-center justify-center rounded-xl text-foreground hover:bg-zinc-100 lg:hidden"
      ...
      <button
        ...
        className="touch-target rounded-xl px-3 py-2 text-sm font-medium text-muted hover:bg-zinc-100 hover:text-foreground"
      >
        Sign out
      </button>
    </header>
