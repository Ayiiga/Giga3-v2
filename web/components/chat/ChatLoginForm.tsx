    ...
    <div className="flex min-h-[100dvh] flex-col items-center justify-center px-4">
      <div className="glass w-full max-w-md rounded-2xl p-8 sm:p-10">
        <div className="mb-6 flex items-center justify-center gap-3">
          <BrandLogo size={40} />
          <h1 className="text-2xl font-bold">Sign in to Giga3 AI</h1>
        </div>
        ...
        <form onSubmit={(e) => void handleSubmit(e)} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full rounded-2xl border-2 border-border bg-black/40 px-5 py-3.5 text-base outline-none ring-blue-500/60 focus:ring-2"
